    ...
    <table >
      ...
      <tr>
        <td >Habilitação:</td><td>
          ...
          <option value="Administração Noite - Torloni">Administração Noite - Torloni</option>
          <option value="Administração Noite - Parque Bristol">Administração Noite - Parque Bristol</option>
          <option value="Administração Integrado">Administração Integrado</option>
          <option value="Automação Industrial Noite">Automação Industrial Noite</option>
          <option value="Automação Industrial Integrado">Automação Industrial Integrado</option>
          <option value="Eletronica Noite">Eletronica Noite</option>
          <option value="Eletronica Integrado">Eletronica Integrado</option>
          <option value="Eletrotécncia Noite">Eletrotécncia Noite</option>
          <option value="Informática Tarde">Informática Tarde</option>
          <option value="Informática Integrado">Informática Integrado</option>
          <option value="Mecânica Noite">Mecânica Noite</option>
          <option value="Mecânica Integrado">Mecânica Integrado</option>
          <option value="Logísta Noite">Logísta Noite</option>
          <option value="Mecatrônica Tarde">Mecatrônica Tarde</option>
          <option value="Mecatrônica Noite">Mecatrônica Noite</option>
          <option value="Mecatrônica Integrado">Mecatrônica Integrado</option>
          <option value="Manutenção Automotiva">Manutenção Automotiva</option>
          <option value="Serviços Jurídicos Noite">Serviços Jurídicos Noite</option>
